...
export async function GET(
  ...
  try {
    ...
    const discount = await DiscountService.getDiscountConfigById(params.id);
...
export async function PUT(
  ...
  try {
    ...
    const discount = await DiscountService.updateDiscountConfig(params.id, body);
...
export async function DELETE(
  ...
  try {
    ...
    await DiscountService.deleteDiscountConfig(params.id);
